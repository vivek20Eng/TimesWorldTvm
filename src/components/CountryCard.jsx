...
const CountryCard = ({ country }) => {
  return (
    <Col xs={12} md={6} className="country-grid mb-3">
    <Card className="country-card" style={{ height: '120px' }}>
        ...
        <Col xs={8} className="p-2 d-flex align-items-center">
            ...
            <Card.Title className="mb-0" style={{ fontSize: '16px', color: '#000' }}>{country.name}</Card.Title>
            <Card.Text style={{ fontSize: '14px', color: '#000' }}>{country.region}</Card.Text>
            </Card.Body>
        </Col>
        </Row>
    </Card>
